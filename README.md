...
The McPeak formulation uses the sign relationship between $$
\Delta y \quad \text{and} \quad \Delta\theta
$$ to select the corresponding angular position relative to the reference.
