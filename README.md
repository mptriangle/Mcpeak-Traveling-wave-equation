...
This condition extends the initial $$0^\circ\text{–}180^\circ$$ result to an angular position within the range $$0^\circ\text{–}360^\circ$$, subject to the sign conventions used by the system.
