...
The McPeak formulation uses the sign relationship between $$\Delta y\text{and}\Delta\theta$$ to select the corresponding angular position relative to the reference.
