...
$\Delta\theta = 360^\circ \frac{\Delta t}{T}$\Delta\theta = 360^\circ \frac{\Delta t}{T}
...
The licensing and intellectual-property status of the McPeak Triangle Equation and the McPeak Traveling Wave Equation should be documented separately.

Publicly disclosed mathematical concepts, subsequent technical developments, and any proprietary implementations may have different intellectual-property considerations.

For information regarding permitted use, attribution, or licensing, consult the project's official documentation.
...
│   ├── mcpeak-triangle-equation.md

│   └── mcpeak-traveling-wave-equation.md
...
This document is ready to use as a GitHub README.md.
